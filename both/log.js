Meteor.startup(function(){
	...
	if(typeof errorsToDisplay == "undefined") { errorsToDisplay = []; } // empty those once displayed
	if(typeof successToDisplay =="undefined") { successToDisplay =[]; }// empty those once displayed
