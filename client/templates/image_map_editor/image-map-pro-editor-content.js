;(function ( $, window, document, undefined ) {
    $.image_map_pro_editor_content = function() {
        ...
        html += '<img id="imp-editor-image" src="'+ settings.general.image_url +'">'
        ...
        for (var i=0; i<settings.spots.length; i++) {
            ...
            if (s.type == 'spot') {
                if (parseInt(s.default_style.use_icon, 10) == 1) {
                    ...
                    html += '<div class="imp-editor-shape imp-editor-spot" data-id="'+ s.id +'" style="'+ style +'"><div class="imp-selection" style="border-radius: '+ s.default_style.border_radius +'px;"></div>';
                    ...
                    html += '<div class="imp-editor-shape imp-editor-spot" data-id="'+ s.id +'" style="'+ style +'"><div class="imp-selection" style="border-radius: '+ s.default_style.border_radius +'px;"></div></div>';
                }
            }
            if (s.type == 'rect') {
                var c_bg = hexToRgb(s.default_style.background_color);
                ...
                html += '<div class="imp-editor-shape imp-editor-rect" data-id="'+ s.id +'" style="'+ style +'">';
                ...
                html += '           <div class="imp-selection-translate-box imp-selection-translate-box-1" data-transform-direction="1"></div>';
                html += '           <div class="imp-selection-translate-box imp-selection-translate-box-2" data-transform-direction="2"></div>';
                html += '           <div class="imp-selection-translate-box imp-selection-translate-box-3" data-transform-direction="3"></div>';
                html += '           <div class="imp-selection-translate-box imp-selection-translate-box-4" data-transform-direction="4"></div>';
                html += '           <div class="imp-selection-translate-box imp-selection-translate-box-5" data-transform-direction="5"></div>';
                html += '           <div class="imp-selection-translate-box imp-selection-translate-box-6" data-transform-direction="6"></div>';
                html += '           <div class="imp-selection-translate-box imp-selection-translate-box-7" data-transform-direction="7"></div>';
                html += '           <div class="imp-selection-translate-box imp-selection-translate-box-8" data-transform-direction="8"></div>';
                html += '       </div>';
                html += '   </div>';
                html += '</div>';
            }
            if (s.type == 'oval') {
                ...
                html += '<div class="imp-editor-shape imp-editor-oval" data-id="'+ s.id +'" style="'+ style +'">';
            ...
            if (s.type == 'poly' && s.points) {
                ...
                html += '<div class="imp-editor-shape imp-editor-poly" data-id="'+ s.id +'" style="'+ style +'">';
                html += '   <div class="imp-editor-poly-svg-temp-control-point"></div>';
                ...
                for (var j=0; j<s.points.length; j++) {
                    html += '       <div class="imp-poly-control-point" data-index="'+ j +'" style="left: '+ s.points[j].x +'%; top: ' + s.points[j].y + '%;"></div>';
                }
